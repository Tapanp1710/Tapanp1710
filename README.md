...
- 🧠 Building **AI-powered, production-ready web systems**
- 🏥 Currently working on **EMR platforms & clinical AI tools**
- 🚀 Looking for **Full-Stack / Software / AI Engineer roles**
...
> Deep learning model for blood group classification  
- CNNs with TensorFlow & OpenCV  
- Image-based predictions  

### 🍔 Grabite
> MERN stack food ordering platform  
- JWT authentication  
- REST APIs  
- Cart & search features  
